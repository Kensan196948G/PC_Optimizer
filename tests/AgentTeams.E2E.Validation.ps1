...
function Test-RequiredKeys {
    ...
    Test-RequiredKey -Object $Object -Required $Required -Name $Name
}
...
Test-RequiredKey -Object $auditObj -Required @('schemaVersion','runId','execution','summary','ai','outputs') -Name 'Audit'
...
Test-RequiredKey -Object $pbiObj -Required @('schemaVersion','generatedAt','hostName','score','scoreStatus') -Name 'PowerBI'
...
Test-RequiredKey -Object $summaryObj -Required @('schemaVersion','runId','planner','collector','analyzer','remediator','reporter','mergedByRunAndAgent') -Name 'AgentTeamsSummary'
