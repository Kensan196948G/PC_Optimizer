...
# EP-01: reserved word path (CON) returns InvalidArgs(3)
...
# EP-02: reserved word path (NUL) returns InvalidArgs(3)
& powershell -NoProfile -ExecutionPolicy Bypass -File $ScriptPath `
    -NonInteractive -WhatIf -NoRebootPrompt `
...
# EP-03: reserved word path (LPT1) returns InvalidArgs(3)
& powershell -NoProfile -ExecutionPolicy Bypass -File $ScriptPath `
    -NonInteractive -WhatIf -NoRebootPrompt `
...
# EP-04: whitespace-only path returns InvalidArgs(3)
& powershell -NoProfile -ExecutionPolicy Bypass -File $ScriptPath `
    -NonInteractive -WhatIf -NoRebootPrompt `
...
# EP-05: valid absolute path exits 0
